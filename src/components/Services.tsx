...
const services: ServiceItem[] = [
  ...
  { icon: Settings, title: "Frézování", desc: "Frézováním zvětšíme průměr stávajícího průduchu tak, aby bylo možné vložkování. Pracujeme vlastní profesionální frézou — bez závislosti na subdodavatelích, s rychlejším termínem a přesnější cenou. Frézování provádíme vlastní technikou — bez závislosti na subdodavatelích, s rychlejším termínem a přesnější cenou." },
  ...
  { icon: ShieldCheck, title: "Požární bezpečnost", desc: "Stavíme komíny s důrazem na požární bezpečnost. Certifikované systémové prostupy hořlavými konstrukcemi. Každý komín stavíme s důrazem na požárně bezpečné provedení včetně certifikovaných prostupů hořlavými konstrukcemi." },
];
