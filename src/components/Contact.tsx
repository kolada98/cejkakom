...
function Field({ id, label, type = "text", value, onChange, required, textarea, rows = 5 }: FieldProps) {
  ...
  const inputStyle: React.CSSProperties = {
    ...
    boxShadow: focused ? "0 0 0 4px rgba(240,165,0,0.1)" : "none",
    ...
    >
      <div
        ...
        style={{
          ...
          height: "500px",
          background:
            "radial-gradient(circle at 0% 50%, rgba(240,165,0,0.07), transparent 60%)",
        }}
      />
        ...
        >
          ...
          >
            ...
            <button
              ...
              style={{
                background: "linear-gradient(135deg, #F0A500 0%, #F5B800 100%)",
                color: "#0A1D3A",
                fontFamily: "Plus Jakarta Sans, sans-serif",
                fontWeight: 800,
                fontSize: "0.9375rem",
                ...
                borderRadius: "10px",
                minHeight: "52px",
                boxShadow: "0 8px 24px -8px rgba(240,165,0,0.5)",
              ...
              onMouseEnter={(e) => {
                if (!isLoading) {
                  e.currentTarget.style.transform = "translateY(-2px)";
                  e.currentTarget.style.boxShadow = "0 14px 32px -10px rgba(240,165,0,0.7)";
                }
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow = "0 8px 24px -8px rgba(240,165,0,0.5)";
              }}
            >
              {isLoading ? (
                <>
