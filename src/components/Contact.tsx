    ...
    >
      <div
        ...
        style={{
          ...
          height: "500px",
          background:
            "radial-gradient(circle at 0% 50%, rgba(240,160,0,0.07), transparent 60%)",
        }}
      />
        ...
        >
                  ...
                  <div className="flex items-center gap-4">
                    <div
                      ...
                      style={{
                        width: "48px",
                        height: "48px",
                        backgroundColor: "rgba(240,160,0,0.12)",
                      }}
                    >
          ...
          >
            ...
            <button
              ...
              style={{
                background: "linear-gradient(135deg, #F0A000 0%, #F5B800 100%)",
                color: "#0A1D3A",
                fontFamily: "Plus Jakarta Sans, sans-serif",
                fontWeight: 800,
                fontSize: "0.9375rem",
                ...
                borderRadius: "10px",
                minHeight: "52px",
                boxShadow: "0 8px 24px -8px rgba(240,160,0,0.5)",
