    ...
    >
      <div
        ...
        style={{
          ...
          height: "600px",
          background:
            "radial-gradient(circle at 100% 0%, rgba(240,160,0,0.08), transparent 55%)",
        }}
      />
          ...
          <div className="flex items-center justify-center lg:justify-start">
            <div className="relative" style={{ maxWidth: "440px", width: "100%" }}>
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle at center, rgba(240,160,0,0.22) 0%, transparent 70%)",
                  transform: "scale(1.2)",
                  filter: "blur(24px)",
                }}
              />
              ...
              <div
                ...
                style={{
                  width: 32,
                  height: 32,
                  borderBottom: "3px solid #F0A000",
                  borderRight: "3px solid #F0A000",
              ...
              {stats.map((stat, i) => (
                <div
                  ...
                  style={{
                    ...
                    borderLeft: i === 0 ? "none" : "1px solid rgba(240,160,0,0.25)",
                  }}
                >
                  <div
                    className="text-gold"
